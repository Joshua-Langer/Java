public class Cruise {
    ...
    // print cruise details - Modified by Joshua Langer 6/21/2020
    public void printCruiseDetails() {
        ...
        System.out.println(cruiseName + spaces + cruiseShipName + spaces + "      " + departurePort + spaces + "          " + destination + spaces + "        " + returnPort);
